...
html_sidebars = {
    "index": ["sidebar-about.html", "sidebar-links.html", "searchbox.html"],
    "**": ["sidebar-logo.html", "relations.html", "searchbox.html"],
}
...
latex_documents = [
    ("index", "GeoAlchemy2.tex", "GeoAlchemy2 Documentation", "Eric Lemoine", "manual"),
]
...
man_pages = [("index", "geoalchemy2", "GeoAlchemy2 Documentation", ["Eric Lemoine"], 1)]
