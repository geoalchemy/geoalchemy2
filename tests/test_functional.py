...
from geoalchemy2.functions import ST_AddPoint
...
class TestInsertionORM():
    ...
    def test_AddPoint(self):
        linestring = WKTElement(
            'LINESTRING (-38.4947699836686 -13.0074603244622,'
            '-38.4948490921392 -13.0074922231754,'
            '-38.4949737876624 -13.0075736958192,'
            '-38.4951323665777 -13.0076868979425,'
            '-38.4953356057925 -13.0078866008149,'
            '-38.4953719892206 -13.0079129457036,'
            '-38.49553161356 -13.0078117217386,'
            '-38.4955060623059 -13.0077909246983,'
            '-38.4951968228623 -13.0078884798148,'
            '-38.4947589566826 -13.0080157206016,'
            '-38.4938511085355 -13.0083274678992,'
            '-38.4931990808078 -13.0085567142608,'
            '-38.4928659585901 -13.0087160293379,'
            '-38.4926479457345 -13.0089726240748,'
            '-38.492548721857 -13.0092939120444,'
            '-38.4923194308793 -13.0101869687245,'
            '-38.4921235747504 -13.0106479048475,'
            '-38.4920115562117 -13.0108952002079,'
            '-38.4918909358623 -13.0111019187142,'
            '-38.4917666592884 -13.0111803312555,'
            '-38.4913448251917 -13.0116579424231,'
            '-38.4907371456574 -13.0123016256607,'
            '-38.4907083135947 -13.012299100868,'
            '-38.490217495494 -13.0118518632485)', srid=4326)

        point = WKTElement(
            'Point(-38.49545739041358 -13.007858789510484)',
            srid=4326
        )

        geom = session.execute(ST_AddPoint(linestring, point)).scalar()
        assert isinstance(geom, WKBElement)
        wkt = session.execute(geom.ST_AsText()).scalar()

        new_linestring = session.execute(
            WKTElement(
                'LINESTRING(-38.4947699836686 -13.0074603244622,'
                '-38.4948490921392 -13.0074922231754,'
                '-38.4949737876624 -13.0075736958192,'
                ...
                '-38.4907371456574 -13.0123016256607,'
                '-38.4907083135947 -13.012299100868,'
                '-38.490217495494 -13.0118518632485,'
                '-38.4954573904136 -13.0078587895105)', srid=4326
            ).ST_AsText()
        ).scalar()

        assert wkt == new_linestring
